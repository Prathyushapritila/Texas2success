...
export const services = [
  {
    ...
    overlayType: "dark", // rgba(0,0,0,0.5)
    features: [
  ...
  },
  {
    ...
    overlayType: "cloud", // Cloud/blur effect with subtle cloud icons
    features: [
  ...
  },
  {
    ...
    overlayType: "blue", // #004AAD with 60% opacity
    features: [
  ...
  },
  {
    ...
    overlayType: "orange", // Orange-to-black gradient
    features: [
