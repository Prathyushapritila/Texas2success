        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md mb-8">
              <h2 className="text-3xl font-semibold mb-6 text-gray-800">Our Salesforce Services</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="text-2xl font-semibold mb-3 text-gray-800">Salesforce Implementation</h3>
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3 text-gray-800">Custom Development</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3 text-gray-800">Salesforce Consulting</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3 text-gray-800">Integration Services</h3>
                  <p className="text-gray-700 leading-relaxed">
